...
export default function SiderPage({
  ...
  return (
    <div
      className={
        "fixed top-0 md:flex flex-col w-full md:w-[280px] h-full md:pt-[80px] z-40 md:z-0 gap-[8px] bg-background border-r border-1 border-solid border-[#FFFFFF0D]" +
        (siderVisible ? " flex" : " hidden")
      }
    >
      <div className="flex justify-between gap-1 items-center md:hidden ml-6 mr-16">
        <Image
          src={logoPic}
      ...
      {/* Home Sidebar */}
      <div
        className={"flex flex-col gap-[8px]" + (streamPage ? " md:hidden" : "")}
      >
        <Link
          href="/"
          className={
